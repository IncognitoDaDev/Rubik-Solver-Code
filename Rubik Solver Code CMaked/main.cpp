...
int main()
{
    ...
    while (RubikGame)
    {
        ...
        cin >> move;
            ...
            case ']':
                cout << "F U B L R B" << endl;
                for (int i = 0; i < 6; i++)
                    cout << intTocharColorType(dir[i]) << " ";
                cout << endl;
                break;

            case '[': // Show White Front / Blue Up Cube
            
                cout << "Showing cube with White Front n' Blue Up..." << endl;
                rotateFaceToMatchOrientation(dir, rc, 1);
